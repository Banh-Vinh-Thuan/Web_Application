...
<head>
    ...
    <title>Phu Quoc Island Adventure: National Park - Fish Sauce Factory - Coconut Prison - Sunset Beach</title>
    <meta name="description" content="Explore Phu Quoc's natural beauty and cultural history with our 4-day island adventure including the National Park, Coconut Prison, Sunset Beach, and more.">
...
<main>
    ...
    <div class="gallery" id="lightgallery">
        <a href="phuquoc2/1.jpg" class="big">
            <img src="phuquoc2/1.jpg" alt="Phu Quoc Island" loading="lazy" width="800" height="600">
        </a>
        <a href="phuquoc2/2.jpg" class="small1">
            <img src="phuquoc2/2.jpg" alt="Phu Quoc Beach" loading="lazy" width="400" height="300">
        </a>
        <a href="phuquoc2/3.jpg" class="small2">
            <img src="phuquoc2/3.jpg" alt="Vin Wonders Phu Quoc" loading="lazy" width="400" height="300">
        </a>
        <a href="phuquoc2/4.jpg" class="small3">
            <img src="phuquoc2/4.jpg" alt="Vin Safari Phu Quoc" loading="lazy" width="400" height="300">
        </a>
        <a href="phuquoc2/5.jpg" class="small4">
            <img src="phuquoc2/5.jpg" alt="Hon Thom Cable Car" loading="lazy" width="400" height="300">
        </a>
    </div>
