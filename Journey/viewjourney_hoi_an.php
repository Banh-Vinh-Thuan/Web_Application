            ...
            <div class="tour-container">
               <div class="tour-card" 
                    ...
                    <div class="tour-details">
                        <h3>Hoi An Ancient Town Discovery: Old Quarter - Japanese Bridge - Riverside Market - Lantern Festival</h3>
                        <div class="tour-info">
                            <ul>
                ...
                <div class="tour-card" 
                    ...
                    <div class="tour-details">
                        <h3>Hoi An Cultural Experience: Ancient Town - Riverside Market - Traditional Craft Villages - Lantern Festival</h3>
                        <div class="tour-info">
                            <ul>
                                <li><span class="icon">⏰</span> 4 days 3 nights</li>
                ...
                <div class="tour-card" 
                    ...
                    <div class="tour-details">
                        <h3>Hoi An Heritage & Beach: Ancient Town - My Son Sanctuary - An Bang Beach - Traditional Cooking Class</h3>
                        <div class="tour-info">
                            <ul>
                                <li><span class="icon">⏰</span> 4 days 3 nights</li>
                                <li><span class="icon">📅</span> 28/05, 04/06, 11/06</li>
                                <li><span class="icon">🚌</span> Bus</li>
                                <li><span class="icon">🏨</span> Hotel</li>
                                <li><span class="icon">👥</span> 20</li>
                                <li><span class="icon">🚩</span> Departure: Hanoi</li>
                            ...
                            <div class="price-action">
                                <p class="price">6,290,000 ₫ <span class="original-price">7,140,000 ₫</span></p>
                                <a href="/Tour_detail/hoian_3.php" class="btn">See More</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="tour-card" 
                    ...
                    <div class="tour-details">
                        <h3>Hoi An Nature & Culture: Cam Thanh Village - Thu Bon River Cruise - Marble Mountains - Local Handicraft Workshops</h3>
                        <div class="tour-info">
                            <ul>
                                <li><span class="icon">⏰</span> 4 days 3 nights</li>
                                <li><span class="icon">📅</span> 30/05, 06/06, 13/06</li>
                                <li><span class="icon">🚌</span> Bus</li>
                                <li><span class="icon">🏨</span> Hotel</li>
                            ...
                            <div class="price-action">
                                <p class="price">6,150,000 ₫ <span class="original-price">7,230,000 ₫</span></p>
                                <a href="/Tour_detail/hoian_4.php" class="btn">See More</a>
                            </div>
                        </div>
                    </div>
                </div>
