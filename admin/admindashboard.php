...
<body>
    ...
    <div class="container">
        ...
        <main class="main-content">
            ...
            <div class="chart-container quick-actions loading">
                <div class="chart-header">
                    <h3><i class="fas fa-bolt"></i> Quick Action Center</h3>
                    <p>Streamlined access to essential administrative functions</p>
                </div>
                <div class="actions-grid">
                    <a href="adminviewtourbooking.php" class="action-item">
                        <i class="fas fa-map-marked-alt"></i>
                        <span>Tour Operations</span>
                        <small><?php echo $tour_bookings; ?> active bookings</small>
                    </a>
                    <a href="adminviewhotelbooking.php" class="action-item">
                        <i class="fas fa-hotel"></i>
                        <span>Hotel Operations</span>
                        <small><?php echo $hotel_bookings; ?> reservations</small>
                    </a>
                    <a href="adminviewusers.php" class="action-item">
                        <i class="fas fa-users"></i>
                        <span>User Management</span>
                        <small><?php echo $user_count; ?> registered users</small>
                    </a>
                    <a href="adminviewcity.php" class="action-item">
                ...
                <div class="chart-header" style="margin-top: 2.5rem; margin-bottom: 1.5rem;">
                    <h3><i class="fas fa-server"></i> System Health Monitor</h3>
                    <p>Real-time platform status and operational indicators</p>
                </div>
                <div class="system-status">
                    <div class="status-item">
                        <div class="status-indicator online"></div>
                        <div class="status-info">
                            <div class="status-label">Booking Engine</div>
                            <div class="status-detail">Fully operational</div>
                        </div>
                    </div>
                    <div class="status-item">
                        <div class="status-indicator online"></div>
                        <div class="status-info">
                            <div class="status-label">User Authentication</div>
                            <div class="status-detail">All systems green</div>
                        </div>
                    </div>
                    <div class="status-item">
                        <div class="status-indicator <?php echo $total_pending > 10 ? 'warning' : 'online'; ?>"></div>
                        <div class="status-info">
                            <div class="status-label">Processing Queue</div>
                            <div class="status-detail"><?php echo $total_pending; ?> items pending</div>
                        </div>
                    </div>
                    <div class="status-item">
                        <div class="status-indicator online"></div>
                        <div class="status-info">
                            ...
                            <div class="status-detail">Connected & optimized</div>
                        </div>
                    </div>
                </div>
            </div>
